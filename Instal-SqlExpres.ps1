...
# Variables
$SqlExpressUrl = "[https://go.microsoft.com/fwlink/?linkid=2204847"](https://go.microsoft.com/fwlink/?linkid=2204847")  # Official SQL Server 2022 Express download
...
Invoke-WebRequest -Uri $SqlExpressUrl -OutFile $SqlExpressInstaller
